-- // SECURITY BYPASS LAYER // --
        ...
        local function setupCharacter(char)
            ...
            mainLoopConnection = RunService.RenderStepped:Connect(function(dt)
                ...
                local shouldAutoduckCrouch = Settings.Autoduck and not onGround 
                ...
                if Settings.FastStop and not (keysPressed.W or keysPressed.A or keysPressed.S or keysPressed.D) then
                    ...
                    if onGround and not isLongJumping and not edgebugOnEdge and not pixelsurfActive and not (airstuckPos and Settings.Airstuck) then
                ...
                if isEdgebugKey and onGround then
        ...
        UserInputService.InputBegan:Connect(function(input, gpe)
            ...
            if Settings.Pixelhop and k == Binds.Pixelhop then
                ...
                if not isPixelhopping and (now - lastPixelhopTime) > PIXELHOP_COOLDOWN and not isEdgebugKey then
                    ...
                    local wallHit = nil
                    for _, dir in ipairs(directions) do
                        local ray = workspace:Raycast(currentRoot.Position, dir * PX_WALL_DETECT_DIST, rayParams)
